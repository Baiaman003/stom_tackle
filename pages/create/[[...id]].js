...
const ProductsManager = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (auth.user.role !== 'admin')
      return dispatch({ type: 'NOTIFY', payload: { error: 'Аутентификация недействительна.' } })
    ...
    if (
      ...
      return dispatch({ type: 'NOTIFY', payload: { error: 'Заполните все поля.' } })
    ...
    <div className='products_manager'>
      ...
      <form className='row' onSubmit={handleSubmit}>
        <div className='col-md-6'>
          ...
          <div className='input-group-prepend px-0 my-2 d-flex flex-column'>
