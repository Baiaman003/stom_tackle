  ...
  return (
    <tr>
      ...
      <td style={{ minWidth: '200px' }} className='w-50 align-middle'>
        ...
        <h6 className='text-danger'>{item.quantity * item.price} сом</h6>
        {item.inStock > 0 ? (
          <p className='mb-1 text-danger'>В наличии: {item.inStock}</p>
        ) : (
          <p className='mb-1 text-danger'>Нет на складе</p>
        )}
      </td>
